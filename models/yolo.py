...
def parse_model(d, ch):  # model_dict, input_channels(3)
    ...
    for i, (f, n, m, args) in enumerate(d['backbone'] + d['head']):  # from, number, module, args
        ...
        elif m in {fasternet_l,fasternet_m,fasternet_s,fasternet_t0,fasternet_t0,fasternet_t2}:
            print(args)
            print(*args)
            m = m(*args)
            c2 = m.channel
...
if __name__ == '__main__':
    ...
    parser.add_argument('--cfg', type=str, default='yolov5n-fasternet.yaml', help='model.yaml')
